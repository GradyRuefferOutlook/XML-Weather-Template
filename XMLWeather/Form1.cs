...
namespace XMLWeather
{
    public partial class Form1 : Form
    {
        ...
        public void ExtractCurrent()
        {
            ...
            XmlReader reader = XmlReader.Create("http://api.openweathermap.org/data/2.5/weather?q=" + city + ", " + state + ", " + countryCode + "&mode=xml&units=metric&appid=cd7da378ac74c7d48d029dc694b801e3");
